...
public class ExtendedStoneCutterScreen extends StonecutterScreen {
    StonecutterRecipeBook recipeBook;

    public ExtendedStoneCutterScreen(StonecutterMenu menu, Inventory inventory, Component title) {
