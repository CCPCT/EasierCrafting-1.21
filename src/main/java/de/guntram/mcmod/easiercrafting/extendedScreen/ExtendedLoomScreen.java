...
public class ExtendedLoomScreen extends LoomScreen {
    LoomRecipeBook recipeBook;

    public ExtendedLoomScreen(LoomMenu menu, Inventory inventory, Component title) {
