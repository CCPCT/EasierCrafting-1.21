...
//    private final int firstCraftSlotNo;
//    private final int gridSize;
//    private final int resultSlotNo;
//    public final int firstInventorySlotNo;
//    public final TreeMap<String, CraftingRecipeTreeSet> craftableCategories = new TreeMap<>();
...
//    private final RecipeType<? extends Recipe<? extends RecipeInput>> wantedRecipeType;
//
//    public TextFieldWidget pattern;
//    public CraftingRecipeTreeSet patternMatchingRecipes;
...
//
//
//    public RecipeBook(HandledScreen<? extends ScreenHandler> craftScreen, int firstCraftSlotNo, int gridsize, int resultSlot, int firstInventorySlot) {
...
//            Set<RecipeDisplayEntry> preUpdate = new HashSet<>(RecipeHandler.getCraftableRecipeEntries());
//            updateRecipes();
...
//                // shaped: render in crafting grid (3x3/2x2)
...
//                // shapeless: render stacks in horizontal
...
//
//        if (stacks.isEmpty()) {
//            System.err.println("No stacks can be used for: "+ingredient.getFirst(RecipeHandler.getWorldContext()).getName());
//            return;
//        }
//        int toRender = 0;
//        if (stacks.size() > 1)
...
//
//                }
//                CraftingRecipeTreeSet recipeTreeSet = craftableCategories.get(category);
...
//                    recipeTreeSet = new CraftingRecipeTreeSet();
...
//            }
//        }
//        else if (wantedRecipeType == RecipeType.STONECUTTING) {
//            Map<CuttingRecipeDisplay.GroupEntry<StonecuttingRecipe>, Integer> recipes= RecipeHandler.getCraftableStoneCuttingRecipes();
//            if (recipes.isEmpty()){
//                LOGGER.warn("No recipes for stonecutting found");
//                return;
//            }
//            for (Map.Entry<CuttingRecipeDisplay.GroupEntry<StonecuttingRecipe>, Integer> map : recipes.entrySet()){
//                LOGGER.info("Can craft {} {}", map.getKey().recipe().optionDisplay().getFirst(RecipeHandler.getWorldContext()).getName(), map.getValue());
//            }
//
//        }
//
...
//        for (CraftingRecipeTreeSet tree : craftableCategories.values())
...
//        patternListSize = 0;
//        patternMatchingRecipes = new CraftingRecipeTreeSet(); // Ensure this supports RecipeDisplayEntry
//
...
//        Set<RecipeDisplayEntry> recipes = RecipeHandler.getCraftableRecipeEntries();
//
//        try {
...
////            LOGGER.info("output: " + stack.getItem().getName().getString());
////            for (Ingredient ing : cuttingRecipe.getIngredients()) {
////                ItemStack[] stacks = ing.getMatchingStacks();
////                if (stacks.length > 1) {
////                    LOGGER.info(stacks.length + " possible inputs for " + stack.getItem().getName().getString());
////                    for (ItemStack stack2 : stacks) {
////                        LOGGER.info("    " + stack2.getItem().getName().getString());
////                    }
////                }
////            }
...
////                LOGGER.info("look for dispenser item " + I18n.translate(stacks[0].getItem().getTranslationKey()));
////            }
////            for (int i = 0; i < 36; i++) {
...
////                    if (recipe.getResult(null).getItem() == Items.DISPENSER) {
////                        LOGGER.info("Item in inv slot " + i + ":" + I18n.translate(slotcontent.getItem().getTranslationKey()) + " works");
////                    }
...
////                } else {
////                    if (recipe.getResult(null).getItem() == Items.DISPENSER) {
////                        LOGGER.info("Item in inv slot " + i + ":" + I18n.translate(stacks[0].getItem().getTranslationKey()) + "doesn't work");
////                    }
////                }
////            }
...
//
//        // normal crafting
//        if (underMouse.display() instanceof ShapedCraftingRecipeDisplay || underMouse.display() instanceof ShapelessCraftingRecipeDisplay) {
...
//                    maxCraftableStacks = RecipeHandler.getMaxCraftable(ingredients);
//                }
...
//                return;
//            }
//            if (recipeWidth > gridSize) {
//                // recipe too big for grid
//                // should not happen...
//                return;
//            }
//
//            // check if leftover need to be removed from crafting grid, e.g. milk bucket, honey bottle
...
//
//                        // if item need to be removed
//                        if (!inCraftSlot.getRecipeRemainder().isEmpty()){
//                            System.out.println(i+" need removal");
//                            removal[i] = true;
//                        }
//                    }
//                }
...
//
//                // if needed to remove left over from crafting grid
//                rowadjust=0;
